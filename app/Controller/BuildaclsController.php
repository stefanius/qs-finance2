...
class BuildaclsController extends AppController
{
    ...
    public function initDB()
    {
        ...
        $this->Acl->deny($group, 'controllers/Bookyears/delete');
        $this->Acl->deny($group, 'controllers/Calculations/delete');
        //allow users to only add and edit on posts and widgets
        $group->id = 3;
        $this->Acl->deny($group, 'controllers');
        $this->Acl->allow($group, 'controllers/Pages');
        $this->Acl->allow($group, 'controllers/Bookyears/index');
        $this->Acl->allow($group, 'controllers/Calculations/pre_calculate');
        $this->Acl->allow($group, 'controllers/Calculations/openbalans');
