<div class="boekingstukkens index">
	<h2><?php echo __('Boekingstukkens');?></h2>
	...
	<tr<?php echo $class;?>>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $boekingstukken['Boekingstukken']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $boekingstukken['Boekingstukken']['id'])); ?>
			<?php echo $this->Html->link(__('Delete'), array('action' => 'delete', $boekingstukken['Boekingstukken']['id']), null, sprintf(__('Are you sure you want to delete # %s?'), $boekingstukken['Boekingstukken']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
