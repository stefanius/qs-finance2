...
class Boekingstukken extends AppModel {
	var $name = 'Boekingstukken';
	var $displayField = 'boekingstuk';
	var $validate = array(
		'boekinstuk' => array(
			'notempty' => array(
				'rule' => array('notempty'),
	...
	function getBoekingstukken($bookyear){
	...
	function retrieve($bookyear_id, $number){
		$bookyear_model = ClassRegistry::init('Bookyear');
	...
	function create_new_stukken($bookyear_id, $bookyear_omschrijving=null){
