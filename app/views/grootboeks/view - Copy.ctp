...
<h2><?php  __('Grootboek');?></h2>
	<dl><?php $i = 0; $class = ' class="altrow"';?>
		...
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Debetcredit'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
...
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Grootboek', true), array('action' => 'edit', $grootboek['Grootboek']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('Delete Grootboek', true), array('action' => 'delete', $grootboek['Grootboek']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $grootboek['Grootboek']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('List Grootboeks', true), array('action' => 'index')); ?> </li>
		<li><?php echo $this->Html->link(__('New Grootboek', true), array('action' => 'add')); ?> </li>
