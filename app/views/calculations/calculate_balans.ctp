...
<h1><?php echo '<a href="'.$balansposten['changebalansurl'].'">Per: '.$balansposten['datum'].'</a>'; ?></h1>
	...
	<div class="credit">
		<table cellpadding="0" cellspacing="0">
			...
			<?php
				echo "<tr>";
				echo '<td><a href="'.$this->webroot.'calculations/rekeningoverzicht/'.$boekjaar.'/1">(----) Eigen Vermogen</a></td>';
...
<?php if(isset($balansposten)): ?>
	<?php echo '<a href="'.$this->webroot.'calculations/ExportExcel/'.$boekjaar.'">Download eenvoudige balans(excel)</a></br>'; ?>
	<?php echo '<a href="'.$this->webroot.'calculations/ExportKolomBalans/'.$boekjaar.'">Download Kolombalans(excel)</a></br>'; ?>
	<?php echo '<a href="'.$this->webroot.'calculations/kolombalans/'.$boekjaar.'">Kolombalans</a></br>'; ?>
<?php endif; ?>
